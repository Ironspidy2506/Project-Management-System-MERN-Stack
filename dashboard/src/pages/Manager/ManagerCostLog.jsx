  ...
  const handleSave = async (costId) => {
    try {
      const { data } = await axios.post(
        `https://project-management-system-mern-stack.vercel.app/api/cost/edit-cost-manager/${costId}`,
        editedCost,
        { headers: { mtoken } }
      );
  ...
  const handleDelete = async (costId) => {
    try {
      const { data } = await axios.delete(
        `https://project-management-system-mern-stack.vercel.app/api/cost/delete-cost-manager/${costId}`,
        { headers: { mtoken } }
      );
